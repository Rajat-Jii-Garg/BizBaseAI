    ...
    <section id="who-is-it-for" className="py-10 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
          {audiences.map((a, i) => (
            <div key={i} className="group relative bg-slate-50/70 hover:bg-white border border-slate-100 hover:border-slate-200 hover:shadow-lg rounded-2xl p-4 sm:p-6 min-h-[210px] sm:min-h-[240px] transition-all duration-300">
