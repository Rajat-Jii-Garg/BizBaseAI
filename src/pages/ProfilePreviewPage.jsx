          ...
          <div className="px-4 md:px-6 pb-4 md:pb-6">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between -mt-12 md:-mt-16 relative">
              ...
              <div className="flex gap-2 flex-wrap">
                <Button variant="default" onClick={} size="sm" className="flex-1 md:flex-none">
                  {/* <Share2 className="w-4 h-4 mr-2" /> */}
                  Add Friend
                </Button>
                <Button variant="outline" size="sm" className="flex-1 md:flex-none" onClick={() => navigate(`/messages`)}>
