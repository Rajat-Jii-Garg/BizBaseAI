...
const Events = () => {
  ...
  return (
    <DashboardLayout>
      <SEOHead title="Events - Networking & Workshops" description="Discover professional events, webinars, workshops, and conferences on BizBase AI. Network with industry leaders." path="/events" />
