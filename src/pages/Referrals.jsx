...
const Referrals = () => {
  ...
  return (
    <DashboardLayout>
      <SEOHead title="Referrals - Earn BizCoins" description="Invite friends to BizBase AI and earn BizCoins. Share your referral link and unlock rewards." path="/referrals" noIndex />
